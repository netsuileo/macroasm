...
commands = [
    ...
    {
        "pattern": re.compile("^LXI B,[a-fA-F0-9]{1,4}$"),
        "code": 0x0,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LXI D,[a-fA-F0-9]{1,4}$"),
        "code": 0x2,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LXI H,[a-fA-F0-9]{1,4}$"),
        "code": 0x3,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^SHLD [a-fA-F0-9]{1,4}$"),
        "code": 0x4,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LHLD [a-fA-F0-9]{1,4}$"),
        "code": 0x5,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LXI SP,[a-fA-F0-9]{1,4}$"),
        "code": 0x7,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^STA [a-fA-F0-9]{1,4}$"),
        "code": 0x8,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LDA [a-fA-F0-9]{1,4}$"),
        "code": 0x9,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JNZ [a-fA-F0-9]{1,4}$"),
        "code": 0xa,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JMP [a-fA-F0-9]{1,4}$"),
        "code": 0xb,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CNZ [a-fA-F0-9]{1,4}$"),
        "code": 0xc,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JZ [a-fA-F0-9]{1,4}$"),
        "code": 0xd,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CZ [a-fA-F0-9]{1,4}$"),
        "code": 0xf,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CALL [a-fA-F0-9]{1,4}$"),
        "code": 0x10,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JNC [a-fA-F0-9]{1,4}$"),
        "code": 0x12,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CNC [a-fA-F0-9]{1,4}$"),
        "code": 0x13,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JC [a-fA-F0-9]{1,4}$"),
        "code": 0x14,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CC [a-fA-F0-9]{1,4}$"),
        "code": 0x15,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JPO [a-fA-F0-9]{1,4}$"),
        "code": 0x17,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CPO [a-fA-F0-9]{1,4}$"),
        "code": 0x18,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JPE [a-fA-F0-9]{1,4}$"),
        "code": 0x19,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CPE [a-fA-F0-9]{1,4}$"),
        "code": 0x1a,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JP [a-fA-F0-9]{1,4}$"),
        "code": 0x1b,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CP [a-fA-F0-9]{1,4}$"),
        "code": 0x1c,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JM [a-fA-F0-9]{1,4}$"),
        "code": 0x1d,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CM [a-fA-F0-9]{1,4}$"),
        "code": 0x1f,
        "bytes": 3,
    },
]
