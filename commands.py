...
commands = [
    ...
    {
        "pattern": re.compile("^LXI B,(0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x01,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LXI D,(0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x11,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LXI H,(0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x21,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^SHLD (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x22,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LHLD (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x2a,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LXI SP,(0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x31,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^STA (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x32,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^LDA (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0x3a,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JNZ (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xc2,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JMP (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xc3,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CNZ (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xc4,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JZ (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xca,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CZ (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xcc,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CALL (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xcd,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JNC (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xd2,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CNC (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xd4,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JC (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xda,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CC (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xdc,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JPO (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xe2,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CPO (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xe4,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JPE (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xea,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CPE (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xec,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JP (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xf2,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CP (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xf4,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^JM (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xfa,
        "bytes": 3,
    },
    {
        "pattern": re.compile("^CM (0x[a-fA-F0-9]{1,4}|[a-zA-Z0-9_]+)$"),
        "code": 0xfc,
        "bytes": 3,
    },
]
